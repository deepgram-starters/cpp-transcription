...
C++ (Crow) demo app for Deepgram Transcription.
...
```
feat(cpp-transcription): add diarization support
fix(cpp-transcription): resolve WebSocket close handling
refactor(cpp-transcription): simplify session endpoint
